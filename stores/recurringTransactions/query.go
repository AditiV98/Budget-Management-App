...
const (
	createTransaction   = "INSERT INTO recurring_transactions (user_id, account_id, amount,type,category,description,frequency,custom_days,start_date,end_date,last_run,next_run,created_at) VALUES (?, ?, ?, ?,?,?,?,?,?,?,?,?,?)"
